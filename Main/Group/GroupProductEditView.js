...
export default class GroupProductEditView extends Component{
    constructor (props){
        super(props)
    ...
    onGetProductDetailSuccess(response){
        ...
        if (this.state.goods_detail){
            this.setState({
                ...
                productPrice:this.props.price.toString() ,
                productTypeDetail:this.props.unit,
                productStock:this.props.stock.toString(),
    ...
    saveGroupBuy(){
        if (this.state.isDisable){
            ...
            let productParam ={
                ...
                unit:this.state.productTypeDetail,
                org_goods_id:this.props.org_goods_id,
            ...
            //         index:this.props.index
            //     };
            //     console.log('ChangeProductDetailproductParam13'+JSON.stringify(productParam))
            //     // DeviceEventEmitter.emit('ChangeProductDetail',productParam);
            //     this.props.navigator.pop();
            // }
    ...
    onPressdisEditAlert(){
        Alert.alert('提示','当前页面不支持修改该内容，请到已上传的商品里去编辑', [
            ...
            <View style={styles.container}>
                ...
                <ScrollView ref='scroll'
                    ...
                    <View onStartShouldSetResponderCapture={(e)=>{dismissKeyboard();}}>
                        ...
                        <View style={{}}>
                            <TouchableOpacity onPress={this.onPressdisEditAlert.bind(this)}>
                            <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', backgroundColor: '#ffffff', height: 50, paddingLeft: 10, paddingRight: 10 }}>
                                    ...
                                    <Text style={[ { width: 70, marginRight: 15, color: '#8C8C8C', fontSize: 16, }]}>
                                    商品名称:
                                </Text>
                                <TextInput style={{
                                    marginLeft: 0, fontSize: 16, flex: 20,
                                    textAlign: 'left', color: '#8C8C8C',
